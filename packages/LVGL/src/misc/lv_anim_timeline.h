 ...
 */
lv_anim_timeline_t * lv_anim_timeline_create(void) LV_SECTION;

/**
 * Delete animation timeline.
 * @param at    pointer to the animation timeline.
 */
void lv_anim_timeline_del(lv_anim_timeline_t * at) LV_SECTION;
 ...
 */
void lv_anim_timeline_add(lv_anim_timeline_t * at, uint32_t start_time, lv_anim_t * a) LV_SECTION;
 ...
 */
uint32_t lv_anim_timeline_start(lv_anim_timeline_t * at) LV_SECTION;

/**
 * Stop the animation timeline.
 * @param at    pointer to the animation timeline.
 */
void lv_anim_timeline_stop(lv_anim_timeline_t * at) LV_SECTION;
 ...
 */
void lv_anim_timeline_set_reverse(lv_anim_timeline_t * at, bool reverse) LV_SECTION;
 ...
 */
void lv_anim_timeline_set_progress(lv_anim_timeline_t * at, uint16_t progress) LV_SECTION;
 ...
 * @return total time spent in animation timeline.
 */
uint32_t lv_anim_timeline_get_playtime(lv_anim_timeline_t * at) LV_SECTION;
 ...
 */
bool lv_anim_timeline_get_reverse(lv_anim_timeline_t * at) LV_SECTION;
