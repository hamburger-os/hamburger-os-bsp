 ...
 */
void _lv_anim_core_init(void) LV_SECTION;
 ...
 */
void lv_anim_init(lv_anim_t * a) LV_SECTION;
 ...
 */
static LV_SECTION inline void lv_anim_set_var(lv_anim_t * a, void * var)
{
    a->var = var;
}
 ...
 *                  E.g. lv_obj_set_x
 */
static LV_SECTION inline void lv_anim_set_exec_cb(lv_anim_t * a, lv_anim_exec_xcb_t exec_cb)
{
    a->exec_cb = exec_cb;
}
 ...
 */
static LV_SECTION inline void lv_anim_set_time(lv_anim_t * a, uint32_t duration)
{
    a->time = duration;
}
 ...
 */
static LV_SECTION inline void lv_anim_set_delay(lv_anim_t * a, uint32_t delay)
{
 ...
 */
static LV_SECTION inline void lv_anim_set_values(lv_anim_t * a, int32_t start, int32_t end)
{
    a->start_value = start;
 ...
 */
static LV_SECTION inline void lv_anim_set_custom_exec_cb(lv_anim_t * a, lv_anim_custom_exec_cb_t exec_cb)
{
    a->var     = a;
 ...
 */
static LV_SECTION inline void lv_anim_set_path_cb(lv_anim_t * a, lv_anim_path_cb_t path_cb)
{
    a->path_cb = path_cb;
}
 ...
 */
static LV_SECTION inline void lv_anim_set_start_cb(lv_anim_t * a, lv_anim_start_cb_t start_cb)
{
    a->start_cb = start_cb;
}
 ...
 */
static LV_SECTION inline void lv_anim_set_get_value_cb(lv_anim_t * a, lv_anim_get_value_cb_t get_value_cb)
{
 ...
 */
static LV_SECTION inline void lv_anim_set_ready_cb(lv_anim_t * a, lv_anim_ready_cb_t ready_cb)
{
    a->ready_cb = ready_cb;
}
 ...
 */
static LV_SECTION inline void lv_anim_set_deleted_cb(lv_anim_t * a, lv_anim_deleted_cb_t deleted_cb)
{
 ...
 */
static LV_SECTION inline void lv_anim_set_playback_time(lv_anim_t * a, uint32_t time)
{
 ...
 */
static LV_SECTION inline void lv_anim_set_playback_delay(lv_anim_t * a, uint32_t delay)
{
 ...
 */
static LV_SECTION inline void lv_anim_set_repeat_count(lv_anim_t * a, uint16_t cnt)
{
    a->repeat_cnt = cnt;
}
 ...
 */
static LV_SECTION inline void lv_anim_set_repeat_delay(lv_anim_t * a, uint32_t delay)
{
 ...
 */
static LV_SECTION inline void lv_anim_set_early_apply(lv_anim_t * a, bool en)
{
    a->early_apply = en;
}
 ...
 */
#if LV_USE_USER_DATA
static LV_SECTION inline void lv_anim_set_user_data(lv_anim_t * a, void * user_data)
{
 ...
 */
lv_anim_t * lv_anim_start(const lv_anim_t * a) LV_SECTION;
 ...
 */
static LV_SECTION inline uint32_t lv_anim_get_delay(lv_anim_t * a)
{
    return -a->act_time;
}
 ...
 */
uint32_t lv_anim_get_playtime(lv_anim_t * a) LV_SECTION;
 ...
 */
#if LV_USE_USER_DATA
static LV_SECTION inline void * lv_anim_get_user_data(lv_anim_t * a)
{
    return a->user_data;
}
#endif
 ...
 */
bool lv_anim_del(void * var, lv_anim_exec_xcb_t exec_cb) LV_SECTION;

/**
 * Delete all the animations
 */
void lv_anim_del_all(void) LV_SECTION;
 ...
 */
lv_anim_t * lv_anim_get(void * var, lv_anim_exec_xcb_t exec_cb) LV_SECTION;

/**
 * Get global animation refresher timer.
 * @return pointer to the animation refresher timer.
 */
struct _lv_timer_t * lv_anim_get_timer(void) LV_SECTION;
 ...
 * @return          true: at least 1 animation is deleted, false: no animation is deleted
 */
static LV_SECTION inline bool lv_anim_custom_del(lv_anim_t * a, lv_anim_custom_exec_cb_t exec_cb)
{
 ...
 * @return          pointer to the animation.
 */
static LV_SECTION inline lv_anim_t * lv_anim_custom_get(lv_anim_t * a, lv_anim_custom_exec_cb_t exec_cb)
{
 ...
 */
uint16_t lv_anim_count_running(void) LV_SECTION;
 ...
 */
uint32_t lv_anim_speed_to_time(uint32_t speed, int32_t start, int32_t end) LV_SECTION;
 ...
 */
void lv_anim_refr_now(void) LV_SECTION;
 ...
 */
int32_t lv_anim_path_linear(const lv_anim_t * a) LV_SECTION;
 ...
 * @return      the current value to set
 */
int32_t lv_anim_path_ease_in(const lv_anim_t * a) LV_SECTION;
 ...
 * @return      the current value to set
 */
int32_t lv_anim_path_ease_out(const lv_anim_t * a) LV_SECTION;
 ...
 * @return      the current value to set
 */
int32_t lv_anim_path_ease_in_out(const lv_anim_t * a) LV_SECTION;
 ...
 * @return      the current value to set
 */
int32_t lv_anim_path_overshoot(const lv_anim_t * a) LV_SECTION;
 ...
 * @return      the current value to set
 */
int32_t lv_anim_path_bounce(const lv_anim_t * a) LV_SECTION;
 ...
 * @return      the current value to set
 */
int32_t lv_anim_path_step(const lv_anim_t * a) LV_SECTION;
