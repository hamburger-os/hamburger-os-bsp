 ...
 * GLOBAL PROTOTYPES
 **********************/
lv_obj_t * lv_file_explorer_create(lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_file_explorer_set_quick_access_path(lv_obj_t * obj, lv_file_explorer_dir_t dir, const char * path) LV_SECTION;
#endif
 ...
 */
void lv_file_explorer_set_sort(lv_obj_t * obj, lv_file_explorer_sort_t sort) LV_SECTION;
 ...
 */
const char * lv_file_explorer_get_selected_file_name(const lv_obj_t * obj) LV_SECTION;
 ...
 */
const char * lv_file_explorer_get_current_path(const lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_obj_t * lv_file_explorer_get_header(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_obj_t * lv_file_explorer_get_quick_access_area(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_obj_t * lv_file_explorer_get_path_label(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_obj_t * lv_file_explorer_get_places_list(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_obj_t * lv_file_explorer_get_device_list(lv_obj_t * obj) LV_SECTION;
#endif
 ...
 */
lv_obj_t * lv_file_explorer_get_file_table(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_file_explorer_sort_t lv_file_explorer_get_sort(const lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_file_explorer_open_dir(lv_obj_t * obj, const char * dir) LV_SECTION;
