 ...
 */
lv_res_t lv_event_send(struct _lv_obj_t * obj, lv_event_code_t event_code, void * param) LV_SECTION;
 ...
 */
lv_res_t lv_obj_event_base(const lv_obj_class_t * class_p, lv_event_t * e) LV_SECTION;
 ...
 */
struct _lv_obj_t * lv_event_get_target(lv_event_t * e) LV_SECTION;
 ...
 */
struct _lv_obj_t * lv_event_get_current_target(lv_event_t * e) LV_SECTION;
 ...
 */
lv_event_code_t lv_event_get_code(lv_event_t * e) LV_SECTION;
 ...
 */
void * lv_event_get_param(lv_event_t * e) LV_SECTION;
 ...
 */
void * lv_event_get_user_data(lv_event_t * e) LV_SECTION;
 ...
 * @param e     pointer to the event descriptor
 */
void lv_event_stop_bubbling(lv_event_t * e) LV_SECTION;
 ...
 * @param e     pointer to the event descriptor
 */
void lv_event_stop_processing(lv_event_t * e) LV_SECTION;
 ...
 */
uint32_t lv_event_register_id(void) LV_SECTION;
 ...
 */
void _lv_event_mark_deleted(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_obj_remove_event_cb(struct _lv_obj_t * obj, lv_event_cb_t event_cb) LV_SECTION;
...
bool lv_obj_remove_event_cb_with_user_data(struct _lv_obj_t * obj, lv_event_cb_t event_cb,
                                           const void * event_user_data) LV_SECTION;
 ...
 * @return          true if any event handlers were removed
 */
bool lv_obj_remove_event_dsc(struct _lv_obj_t * obj, struct _lv_event_dsc_t * event_dsc) LV_SECTION;
 ...
 */
void * lv_obj_get_event_user_data(struct _lv_obj_t * obj, lv_event_cb_t event_cb) LV_SECTION;
 ...
 */
lv_indev_t * lv_event_get_indev(lv_event_t * e) LV_SECTION;
 ...
 */
lv_obj_draw_part_dsc_t * lv_event_get_draw_part_dsc(lv_event_t * e) LV_SECTION;
 ...
 */
lv_draw_ctx_t * lv_event_get_draw_ctx(lv_event_t * e) LV_SECTION;
 ...
 */
const lv_area_t * lv_event_get_old_size(lv_event_t * e) LV_SECTION;
 ...
 */
uint32_t lv_event_get_key(lv_event_t * e) LV_SECTION;
 ...
 */
lv_anim_t * lv_event_get_scroll_anim(lv_event_t * e) LV_SECTION;
 ...
 */
void lv_event_set_ext_draw_size(lv_event_t * e, lv_coord_t size) LV_SECTION;
 ...
 */
lv_point_t * lv_event_get_self_size_info(lv_event_t * e) LV_SECTION;
 ...
 */
lv_hit_test_info_t * lv_event_get_hit_test_info(lv_event_t * e) LV_SECTION;
 ...
 */
const lv_area_t * lv_event_get_cover_area(lv_event_t * e) LV_SECTION;
 ...
 */
void lv_event_set_cover_res(lv_event_t * e, lv_cover_res_t res) LV_SECTION;
