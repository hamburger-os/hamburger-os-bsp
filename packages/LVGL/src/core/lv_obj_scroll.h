 ...
 */
void lv_obj_set_scrollbar_mode(struct _lv_obj_t * obj, lv_scrollbar_mode_t mode) LV_SECTION;
 ...
 */
void lv_obj_set_scroll_dir(struct _lv_obj_t * obj, lv_dir_t dir) LV_SECTION;
 ...
 */
void lv_obj_set_scroll_snap_x(struct _lv_obj_t * obj, lv_scroll_snap_t align) LV_SECTION;
 ...
 * @param align     the snap align to set from `lv_scroll_snap_t`
 */
void lv_obj_set_scroll_snap_y(struct _lv_obj_t * obj, lv_scroll_snap_t align) LV_SECTION;
 ...
 */
lv_scrollbar_mode_t lv_obj_get_scrollbar_mode(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @param dir       the allow scroll directions. An element or OR-ed values of `lv_dir_t`
 */
lv_dir_t lv_obj_get_scroll_dir(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_scroll_snap_t lv_obj_get_scroll_snap_x(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @return          the current snap align from `lv_scroll_snap_t`
 */
lv_scroll_snap_t lv_obj_get_scroll_snap_y(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_scroll_x(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_scroll_y(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_scroll_top(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_scroll_bottom(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_scroll_left(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_scroll_right(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_get_scroll_end(struct _lv_obj_t  * obj, lv_point_t * end) LV_SECTION;
 ...
 */
void lv_obj_scroll_by(struct _lv_obj_t * obj, lv_coord_t x, lv_coord_t y, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 * @note            e.g. dy = -20 means scroll down 20 px
 */
void lv_obj_scroll_by_bounded(struct _lv_obj_t * obj, lv_coord_t dx, lv_coord_t dy, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 * @param anim_en   LV_ANIM_ON: scroll with animation; LV_ANIM_OFF: scroll immediately
 */
void lv_obj_scroll_to(struct _lv_obj_t * obj, lv_coord_t x, lv_coord_t y, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 * @param anim_en   LV_ANIM_ON: scroll with animation; LV_ANIM_OFF: scroll immediately
 */
void lv_obj_scroll_to_x(struct _lv_obj_t * obj, lv_coord_t x, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 * @param anim_en   LV_ANIM_ON: scroll with animation; LV_ANIM_OFF: scroll immediately
 */
void lv_obj_scroll_to_y(struct _lv_obj_t * obj, lv_coord_t y, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 * @param anim_en   LV_ANIM_ON: scroll with animation; LV_ANIM_OFF: scroll immediately
 */
void lv_obj_scroll_to_view(struct _lv_obj_t * obj, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 * @param anim_en   LV_ANIM_ON: scroll with animation; LV_ANIM_OFF: scroll immediately
 */
void lv_obj_scroll_to_view_recursive(struct _lv_obj_t * obj, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 */
lv_res_t _lv_obj_scroll_by_raw(struct _lv_obj_t * obj, lv_coord_t x, lv_coord_t y) LV_SECTION;
 ...
 */
bool lv_obj_is_scrolling(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_update_snap(struct _lv_obj_t * obj, lv_anim_enable_t anim_en) LV_SECTION;
 ...
 */
void lv_obj_get_scrollbar_area(struct _lv_obj_t * obj, lv_area_t * hor, lv_area_t * ver) LV_SECTION;

/**
 * Invalidate the area of the scrollbars
 * @param obj       pointer to an object
 */
void lv_obj_scrollbar_invalidate(struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @param anim_en   LV_ANIM_ON/OFF
 */
void lv_obj_readjust_scroll(struct _lv_obj_t * obj, lv_anim_enable_t anim_en) LV_SECTION;
