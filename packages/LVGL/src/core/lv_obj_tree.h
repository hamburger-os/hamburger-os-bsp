 ...
 */
void lv_obj_del(struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @param obj       pointer to an object
 */
void lv_obj_clean(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_del_delayed(struct _lv_obj_t * obj, uint32_t delay_ms) LV_SECTION;

/**
 * A function to be easily used in animation ready callback to delete an object when the animation is ready
 * @param a         pointer to the animation
 */
void lv_obj_del_anim_ready_cb(lv_anim_t * a) LV_SECTION;
 ...
 * @see lv_async_call
 */
void lv_obj_del_async(struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_set_parent(struct _lv_obj_t * obj, struct _lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_obj_swap(struct _lv_obj_t * obj1, struct _lv_obj_t * obj2) LV_SECTION;
 ...
 */
void lv_obj_move_to_index(struct _lv_obj_t * obj, int32_t index) LV_SECTION;
 ...
 */
struct _lv_obj_t * lv_obj_get_screen(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_disp_t * lv_obj_get_disp(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
struct _lv_obj_t * lv_obj_get_parent(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
struct _lv_obj_t * lv_obj_get_child(const struct _lv_obj_t * obj, int32_t id) LV_SECTION;
 ...
 */
uint32_t lv_obj_get_child_cnt(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
uint32_t lv_obj_get_index(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_tree_walk(struct _lv_obj_t * start_obj, lv_obj_tree_walk_cb_t cb, void * user_data) LV_SECTION;
