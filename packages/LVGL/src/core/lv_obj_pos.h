 ...
 */
void lv_obj_set_pos(struct _lv_obj_t * obj, lv_coord_t x, lv_coord_t y) LV_SECTION;
 ...
 * @note            The values can be set in pixel or in percentage of parent size with `lv_pct(v)`
 */
void lv_obj_set_x(struct _lv_obj_t * obj, lv_coord_t x) LV_SECTION;
 ...
 * @note            The values can be set in pixel or in percentage of parent size with `lv_pct(v)`
 */
void lv_obj_set_y(struct _lv_obj_t * obj, lv_coord_t y) LV_SECTION;
 ...
 */
void lv_obj_set_size(struct _lv_obj_t * obj, lv_coord_t w, lv_coord_t h) LV_SECTION;
 ...
 */
bool lv_obj_refr_size(struct _lv_obj_t * obj) LV_SECTION;
 ...
 *                                      x should be in [0..1000]% range
 */
void lv_obj_set_width(struct _lv_obj_t * obj, lv_coord_t w) LV_SECTION;
 ...
 *                                      x should be in [0..1000]% range
 */
void lv_obj_set_height(struct _lv_obj_t * obj, lv_coord_t h) LV_SECTION;
 ...
 */
void lv_obj_set_content_width(struct _lv_obj_t * obj, lv_coord_t w) LV_SECTION;
 ...
 */
void lv_obj_set_content_height(struct _lv_obj_t * obj, lv_coord_t h) LV_SECTION;
 ...
 */
void lv_obj_set_layout(struct _lv_obj_t * obj, uint32_t layout) LV_SECTION;
 ...
 */
bool lv_obj_is_layout_positioned(const struct _lv_obj_t * obj) LV_SECTION;

/**
 * Mark the object for layout update.
 * @param obj      pointer to an object whose children needs to be updated
 */
void lv_obj_mark_layout_as_dirty(struct _lv_obj_t * obj) LV_SECTION;

/**
 * Update the layout of an object.
 * @param obj      pointer to an object whose children needs to be updated
 */
void lv_obj_update_layout(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
uint32_t lv_layout_register(lv_layout_update_cb_t cb, void * user_data) LV_SECTION;
 ...
 */
void lv_obj_set_align(struct _lv_obj_t * obj, lv_align_t align) LV_SECTION;
 ...
 */
void lv_obj_align(struct _lv_obj_t * obj, lv_align_t align, lv_coord_t x_ofs, lv_coord_t y_ofs) LV_SECTION;
 ...
 */
static LV_SECTION inline void lv_obj_center(struct _lv_obj_t * obj)
{
 ...
 */
void lv_obj_get_coords(const struct _lv_obj_t * obj, lv_area_t * coords) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_x(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @note            The returned value is always the distance from the parent even if `obj` is positioned by a layout.
 */
lv_coord_t lv_obj_get_x2(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @note            The returned value is always the distance from the parent even if `obj` is positioned by a layout.
 */
lv_coord_t lv_obj_get_y(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 * @note            The returned value is always the distance from the parent even if `obj` is positioned by a layout.
 */
lv_coord_t lv_obj_get_y2(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_x_aligned(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_y_aligned(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_width(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_height(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_content_width(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_content_height(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_get_content_coords(const struct _lv_obj_t * obj, lv_area_t * area) LV_SECTION;
 ...
 */
lv_coord_t lv_obj_get_self_width(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 *                  It just tells how large the internal ("virtual") content is.
 */
lv_coord_t lv_obj_get_self_height(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_obj_refresh_self_size(struct _lv_obj_t * obj) LV_SECTION;

void lv_obj_refr_pos(struct _lv_obj_t * obj) LV_SECTION;

void lv_obj_move_to(struct _lv_obj_t * obj, lv_coord_t x, lv_coord_t y) LV_SECTION;


void lv_obj_move_children_by(struct _lv_obj_t * obj, lv_coord_t x_diff, lv_coord_t y_diff, bool ignore_floating) LV_SECTION;
 ...
 */
void lv_obj_transform_point(const struct _lv_obj_t * obj, lv_point_t * p, bool recursive, bool inv) LV_SECTION;
 ...
 * @param inv           do the inverse of the transformation (-angle and 1/zoom)
 */
void lv_obj_get_transformed_area(const struct _lv_obj_t * obj, lv_area_t * area, bool recursive, bool inv) LV_SECTION;
 ...
 */
void lv_obj_invalidate_area(const struct _lv_obj_t * obj, const lv_area_t * area) LV_SECTION;

/**
 * Mark the object as invalid to redrawn its area
 * @param obj       pointer to an object
 */
void lv_obj_invalidate(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_obj_area_is_visible(const struct _lv_obj_t * obj, lv_area_t * area) LV_SECTION;
 ...
 * @return      true: visible; false not visible (hidden, out of parent, on other screen, etc)
 */
bool lv_obj_is_visible(const struct _lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_obj_set_ext_click_area(struct _lv_obj_t * obj, lv_coord_t size) LV_SECTION;
 ...
 */
void lv_obj_get_click_area(const struct _lv_obj_t * obj, lv_area_t * area) LV_SECTION;
 ...
 */
bool lv_obj_hit_test(struct _lv_obj_t * obj, const lv_point_t * point) LV_SECTION;
 ...
 */
lv_coord_t lv_clamp_width(lv_coord_t width, lv_coord_t min_width, lv_coord_t max_width, lv_coord_t ref_width) LV_SECTION;
 ...
 */
lv_coord_t lv_clamp_height(lv_coord_t height, lv_coord_t min_height, lv_coord_t max_height, lv_coord_t ref_height) LV_SECTION;
