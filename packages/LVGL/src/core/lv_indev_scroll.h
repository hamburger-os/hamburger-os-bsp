 ...
 */
void _lv_indev_scroll_handler(_lv_indev_proc_t * proc) LV_SECTION;

/**
 * Handle throwing after scrolling. Called by LVGL during input device processing
 * @param proc      pointer to an input device's proc field
 */
void _lv_indev_scroll_throw_handler(_lv_indev_proc_t * proc) LV_SECTION;
 ...
 */
lv_coord_t lv_indev_scroll_throw_predict(lv_indev_t * indev, lv_dir_t dir) LV_SECTION;
 ...
 */
void lv_indev_scroll_get_snap_dist(lv_obj_t * obj, lv_point_t * p) LV_SECTION;
