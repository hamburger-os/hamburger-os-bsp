 ...
 *  STATIC PROTOTYPES
 **********************/
static void * fs_open(lv_fs_drv_t * drv, const char * path, lv_fs_mode_t mode) LV_SECTION;
static lv_fs_res_t fs_close(lv_fs_drv_t * drv, void * file_p) LV_SECTION;
static lv_fs_res_t fs_read(lv_fs_drv_t * drv, void * file_p, void * buf, uint32_t btr, uint32_t * br) LV_SECTION;
static lv_fs_res_t fs_write(lv_fs_drv_t * drv, void * file_p, const void * buf, uint32_t btw, uint32_t * bw) LV_SECTION;
static lv_fs_res_t fs_seek(lv_fs_drv_t * drv, void * file_p, uint32_t pos, lv_fs_whence_t whence) LV_SECTION;
static lv_fs_res_t fs_tell(lv_fs_drv_t * drv, void * file_p, uint32_t * pos_p) LV_SECTION;
static void * fs_dir_open(lv_fs_drv_t * drv, const char * path) LV_SECTION;
static lv_fs_res_t fs_dir_read(lv_fs_drv_t * drv, void * dir_p, char * fn) LV_SECTION;
static lv_fs_res_t fs_dir_close(lv_fs_drv_t * drv, void * dir_p) LV_SECTION;
