...
/*Fix typo*/
static LV_SECTION inline void * lv_msg_subscribe(uint32_t msg_id, lv_msg_subscribe_cb_t cb, void * user_data)
{
    return lv_msg_subsribe(msg_id, cb, user_data);
}

static LV_SECTION inline void * lv_msg_subscribe_obj(uint32_t msg_id, lv_obj_t * obj, void * user_data)
{
