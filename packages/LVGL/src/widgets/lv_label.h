 ...
 */
lv_obj_t * lv_label_create(lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_label_set_text(lv_obj_t * obj, const char * text) LV_SECTION;

/**
 * Set a new formatted text for a label. Memory will be allocated to store the text by the label.
 * @param obj           pointer to a label object
 * @param fmt           `printf`-like format
 * @example lv_label_set_text_fmt(label1, "%d user", user_num) LV_SECTION;
 */
void lv_label_set_text_fmt(lv_obj_t * obj, const char * fmt, ...) LV_FORMAT_ATTRIBUTE(2, 3) LV_SECTION;
 ...
 */
void lv_label_set_text_static(lv_obj_t * obj, const char * text) LV_SECTION;
 ...
 */
void lv_label_set_long_mode(lv_obj_t * obj, lv_label_long_mode_t long_mode) LV_SECTION;
 ...
 */
void lv_label_set_recolor(lv_obj_t * obj, bool en) LV_SECTION;
 ...
 */
void lv_label_set_text_sel_start(lv_obj_t * obj, uint32_t index) LV_SECTION;
 ...
 */
void lv_label_set_text_sel_end(lv_obj_t * obj, uint32_t index) LV_SECTION;
 ...
 */
char * lv_label_get_text(const lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_label_long_mode_t lv_label_get_long_mode(const lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_label_get_recolor(const lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_label_get_letter_pos(const lv_obj_t * obj, uint32_t char_id, lv_point_t * pos) LV_SECTION;
 ...
 */
uint32_t lv_label_get_letter_on(const lv_obj_t * obj, lv_point_t * pos_in) LV_SECTION;
 ...
 */
bool lv_label_is_char_under_pos(const lv_obj_t * obj, lv_point_t * pos) LV_SECTION;
 ...
 */
uint32_t lv_label_get_text_selection_start(const lv_obj_t * obj) LV_SECTION;
 ...
 */
uint32_t lv_label_get_text_selection_end(const lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_label_ins_text(lv_obj_t * obj, uint32_t pos, const char * txt) LV_SECTION;
 ...
 */
void lv_label_cut_text(lv_obj_t * obj, uint32_t pos, uint32_t cnt) LV_SECTION;
