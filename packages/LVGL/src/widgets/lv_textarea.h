 ...
 */
lv_obj_t * lv_textarea_create(lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_textarea_add_char(lv_obj_t * obj, uint32_t c) LV_SECTION;
 ...
 */
void lv_textarea_add_text(lv_obj_t * obj, const char * txt) LV_SECTION;

/**
 * Delete a the left character from the current cursor position
 * @param obj       pointer to a text area object
 */
void lv_textarea_del_char(lv_obj_t * obj) LV_SECTION;

/**
 * Delete the right character from the current cursor position
 * @param obj       pointer to a text area object
 */
void lv_textarea_del_char_forward(lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_textarea_set_text(lv_obj_t * obj, const char * txt) LV_SECTION;
 ...
 * @param txt       pointer to the text
 */
void lv_textarea_set_placeholder_text(lv_obj_t * obj, const char * txt) LV_SECTION;
 ...
 */
void lv_textarea_set_cursor_pos(lv_obj_t * obj, int32_t pos) LV_SECTION;
 ...
 */
void lv_textarea_set_cursor_click_pos(lv_obj_t * obj, bool en) LV_SECTION;
 ...
 */
void lv_textarea_set_password_mode(lv_obj_t * obj, bool en) LV_SECTION;
 ...
 */
void lv_textarea_set_password_bullet(lv_obj_t * obj, const char * bullet) LV_SECTION;
 ...
 */
void lv_textarea_set_one_line(lv_obj_t * obj, bool en) LV_SECTION;
 ...
 */
void lv_textarea_set_accepted_chars(lv_obj_t * obj, const char * list) LV_SECTION;
 ...
 */
void lv_textarea_set_max_length(lv_obj_t * obj, uint32_t num) LV_SECTION;
 ...
 */
void lv_textarea_set_insert_replace(lv_obj_t * obj, const char * txt) LV_SECTION;
 ...
 */
void lv_textarea_set_text_selection(lv_obj_t * obj, bool en) LV_SECTION;
 ...
 */
void lv_textarea_set_password_show_time(lv_obj_t * obj, uint16_t time) LV_SECTION;
 ...
 */
void lv_textarea_set_align(lv_obj_t * obj, lv_text_align_t align) LV_SECTION;
 ...
 */
const char * lv_textarea_get_text(const lv_obj_t * obj) LV_SECTION;
 ...
 * @return          pointer to the text
 */
const char * lv_textarea_get_placeholder_text(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_obj_t * lv_textarea_get_label(const lv_obj_t * obj) LV_SECTION;
 ...
 */
uint32_t lv_textarea_get_cursor_pos(const lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_textarea_get_cursor_click_pos(lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_textarea_get_password_mode(const lv_obj_t * obj) LV_SECTION;
 ...
 */
const char * lv_textarea_get_password_bullet(lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_textarea_get_one_line(const lv_obj_t * obj) LV_SECTION;
 ...
 */
const char * lv_textarea_get_accepted_chars(lv_obj_t * obj) LV_SECTION;
 ...
 */
uint32_t lv_textarea_get_max_length(lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_textarea_text_is_selected(const lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_textarea_get_text_selection(lv_obj_t * obj) LV_SECTION;
 ...
 */
uint16_t lv_textarea_get_password_show_time(lv_obj_t * obj) LV_SECTION;
 ...
 * @param obj       pointer to a text area object
 */
void lv_textarea_clear_selection(lv_obj_t * obj) LV_SECTION;

/**
 * Move the cursor one character right
 * @param obj       pointer to a text area object
 */
void lv_textarea_cursor_right(lv_obj_t * obj) LV_SECTION;

/**
 * Move the cursor one character left
 * @param obj       pointer to a text area object
 */
void lv_textarea_cursor_left(lv_obj_t * obj) LV_SECTION;

/**
 * Move the cursor one line down
 * @param obj       pointer to a text area object
 */
void lv_textarea_cursor_down(lv_obj_t * obj) LV_SECTION;

/**
 * Move the cursor one line up
 * @param obj       pointer to a text area object
 */
void lv_textarea_cursor_up(lv_obj_t * obj) LV_SECTION;
