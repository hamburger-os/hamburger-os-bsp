 ...
 */
lv_obj_t * lv_bar_create(lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_bar_set_value(lv_obj_t * obj, int32_t value, lv_anim_enable_t anim) LV_SECTION;
 ...
 * @param anim      LV_ANIM_ON: set the value with an animation; LV_ANIM_OFF: change the value immediately
 */
void lv_bar_set_start_value(lv_obj_t * obj, int32_t start_value, lv_anim_enable_t anim) LV_SECTION;
 ...
 */
void lv_bar_set_range(lv_obj_t * obj, int32_t min, int32_t max) LV_SECTION;
 ...
 */
void lv_bar_set_mode(lv_obj_t * obj, lv_bar_mode_t mode) LV_SECTION;
 ...
 */
int32_t lv_bar_get_value(const lv_obj_t * obj) LV_SECTION;
 ...
 */
int32_t lv_bar_get_start_value(const lv_obj_t * obj) LV_SECTION;
 ...
 */
int32_t lv_bar_get_min_value(const lv_obj_t * obj) LV_SECTION;
 ...
 */
int32_t lv_bar_get_max_value(const lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_bar_mode_t lv_bar_get_mode(lv_obj_t * obj) LV_SECTION;
