 ...
 */
lv_obj_t * lv_roller_create(lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_roller_set_options(lv_obj_t * obj, const char * options, lv_roller_mode_t mode) LV_SECTION;
 ...
 */
void lv_roller_set_selected(lv_obj_t * obj, uint16_t sel_opt, lv_anim_enable_t anim) LV_SECTION;
 ...
 */
void lv_roller_set_visible_row_count(lv_obj_t * obj, uint8_t row_cnt) LV_SECTION;
 ...
 */
uint16_t lv_roller_get_selected(const lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_roller_get_selected_str(const lv_obj_t * obj, char * buf, uint32_t buf_size) LV_SECTION;
 ...
 */
const char * lv_roller_get_options(const lv_obj_t * obj) LV_SECTION;
 ...
 */
uint16_t lv_roller_get_option_cnt(const lv_obj_t * obj) LV_SECTION;
