 ...
 */
lv_obj_t * lv_dropdown_create(lv_obj_t * parent) LV_SECTION;
 ...
 */
void lv_dropdown_set_text(lv_obj_t * obj, const char * txt) LV_SECTION;
 ...
 */
void lv_dropdown_set_options(lv_obj_t * obj, const char * options) LV_SECTION;
 ...
 */
void lv_dropdown_set_options_static(lv_obj_t * obj, const char * options) LV_SECTION;
 ...
 */
void lv_dropdown_add_option(lv_obj_t * obj, const char * option, uint32_t pos) LV_SECTION;

/**
 * Clear all options in a drop-down list.  Works with both static and dynamic options.
 * @param obj       pointer to drop-down list object
 */
void lv_dropdown_clear_options(lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_dropdown_set_selected(lv_obj_t * obj, uint16_t sel_opt) LV_SECTION;
 ...
 */
void lv_dropdown_set_dir(lv_obj_t * obj, lv_dir_t dir) LV_SECTION;
 ...
 */
void lv_dropdown_set_symbol(lv_obj_t * obj, const void * symbol) LV_SECTION;
 ...
 */
void lv_dropdown_set_selected_highlight(lv_obj_t * obj, bool en) LV_SECTION;
 ...
 */
lv_obj_t * lv_dropdown_get_list(lv_obj_t * obj) LV_SECTION;
 ...
 */
const char * lv_dropdown_get_text(lv_obj_t * obj) LV_SECTION;
 ...
 */
const char * lv_dropdown_get_options(const lv_obj_t * obj) LV_SECTION;

/**
 * Get the index of the selected option
 * @param obj       pointer to drop-down list object
 * @return          index of the selected option (0 ... number of option - 1) LV_SECTION;
 */
uint16_t lv_dropdown_get_selected(const lv_obj_t * obj) LV_SECTION;
 ...
 */
uint16_t lv_dropdown_get_option_cnt(const lv_obj_t * obj) LV_SECTION;
 ...
 */
void lv_dropdown_get_selected_str(const lv_obj_t * obj, char * buf, uint32_t buf_size) LV_SECTION;
 ...
 */
int32_t lv_dropdown_get_option_index(lv_obj_t * obj, const char * option) LV_SECTION;
 ...
 */
const char * lv_dropdown_get_symbol(lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_dropdown_get_selected_highlight(lv_obj_t * obj) LV_SECTION;
 ...
 */
lv_dir_t lv_dropdown_get_dir(const lv_obj_t * obj) LV_SECTION;
 ...
 * @param obj       pointer to drop-down list object
 */
void lv_dropdown_open(lv_obj_t * dropdown_obj) LV_SECTION;

/**
 * Close (Collapse) the drop-down list
 * @param obj       pointer to drop-down list object
 */
void lv_dropdown_close(lv_obj_t * obj) LV_SECTION;
 ...
 */
bool lv_dropdown_is_open(lv_obj_t * obj) LV_SECTION;
