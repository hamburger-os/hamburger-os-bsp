...
#error \
    ...
    if (sAlignINT8 != ALIGNOF(INT8))
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment: %lu != %u [ALIGNOF(INT8)]\n",
                     sAlignINT8,
    ...
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment: %lu != %u [ALIGNOF(INT16)]\n",
                     sAlignINT16,
    ...
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment: %lu != %u [ALIGNOF(INT32)]\n",
                     sAlignINT32,
    ...
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment: %lu != %u [ALIGNOF(REAL32)]\n",
                     sAlignREAL32,
                     (unsigned int) ALIGNOF(REAL32));
    }
    else if (sAlignTIMEDATE48 != ALIGNOF(TIMEDATE48))
    {
        vos_printLog(VOS_LOG_ERROR, "Unexpected alignment: %lu != %u [ALIGNOF(TIMEDATE48)]\n", sAlignTIMEDATE48,
                     (unsigned int) ALIGNOF(TIMEDATE48));
    }
    else if (sAlignINT64 != ALIGNOF(INT64))
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment: %lu != %u [ALIGNOF(INT64)]\n",
                     sAlignINT64,
    ...
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment: %lu != %u [ALIGNOF(REAL64)]\n",
                     sAlignREAL64,
    ...
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment 1: %lu != %u [ALIGNOF(TIMEDATE48)]\n",
    ...
    {
        vos_printLog(VOS_LOG_ERROR,
                     "Unexpected alignment 2: %lu != %u [ALIGNOF(TIMEDATE48)]\n",
