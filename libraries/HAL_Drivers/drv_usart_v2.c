...
static int stm32_putc(struct rt_serial_device *serial, char c)
{
    ...
    uart = rt_container_of(serial, struct stm32_uart, serial);
    stm32_rs485_dere(uart, RS485_DE);
    UART_INSTANCE_CLEAR_FUNCTION(&(uart->handle), UART_FLAG_TC);
    UART_SET_TDR(&uart->handle, c);
    while (__HAL_UART_GET_FLAG(&(uart->handle), UART_FLAG_TC) == RESET);
    stm32_rs485_dere(uart, RS485_RE);
...
static void stm32_uart_get_config(void)
{
    ...
    uart_obj[UART1_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART2_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART3_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART4_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART5_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART6_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART7_INDEX].rs485_flag = 0;
    ...
    uart_obj[UART8_INDEX].rs485_flag = 0;
