...
#define UART7_DMA_RX_IRQHandler          DMA1_Stream2_IRQHandler
#define UART7_RX_DMA_RCC                 RCC_AHB1ENR_DMA1EN
#define UART7_RX_DMA_INSTANCE            DMA1_Stream2
#define UART7_RX_DMA_REQUEST             DMA_REQUEST_UART7_RX
#define UART7_RX_DMA_IRQ                 DMA1_Stream2_IRQn
...
#define ADC3_DMA_REQUEST              DMA_REQUEST_ADC3
...
#elif defined(BSP_I2S1_RX_USING_DMA) && !defined(I2S1_RX_DMA_INSTANCE)
#define I2S1_DMA_RX_IRQHandler           DMA2_Stream0_IRQHandler
#define I2S1_RX_DMA_RCC                  RCC_AHB1ENR_DMA2EN
#define I2S1_RX_DMA_INSTANCE             DMA2_Stream0
#define I2S1_RX_DMA_REQUEST              DMA_REQUEST_SPI1_RX
#define I2S1_RX_DMA_IRQ                  DMA2_Stream0_IRQn
...
#define MEMTOMEM0_DMA_REQUEST              DMA_REQUEST_MEM2MEM
#define MEMTOMEM0_DMA_IRQ                  DMA2_Stream0_IRQn
#endif

/* DMA2 stream1 */
#if defined(BSP_MEMTOMEM1_USING_DMA) && !defined(MEMTOMEM1_DMA_INSTANCE)
...
#define MEMTOMEM1_DMA_REQUEST              DMA_REQUEST_MEM2MEM
...
#define MEMTOMEM2_DMA_REQUEST              DMA_REQUEST_MEM2MEM
...
#define MEMTOMEM3_DMA_REQUEST              DMA_REQUEST_MEM2MEM
...
#define MEMTOMEM4_DMA_REQUEST              DMA_REQUEST_MEM2MEM
...
#elif defined(BSP_I2S1_TX_USING_DMA) && !defined(I2S1_TX_DMA_INSTANCE)
#define I2S1_DMA_TX_IRQHandler           DMA2_Stream5_IRQHandler
#define I2S1_TX_DMA_RCC                  RCC_AHB1ENR_DMA2EN
#define I2S1_TX_DMA_INSTANCE             DMA2_Stream5
#define I2S1_TX_DMA_REQUEST              DMA_REQUEST_SPI1_TX
#define I2S1_TX_DMA_IRQ                  DMA2_Stream5_IRQn
#elif defined(BSP_UART1_RX_USING_DMA) && !defined(UART1_RX_DMA_INSTANCE)
...
#define MEMTOMEM5_DMA_REQUEST              DMA_REQUEST_MEM2MEM
...
/* DMA2 stream6 */
#if defined(BSP_MEMTOMEM6_USING_DMA) && !defined(MEMTOMEM6_DMA_INSTANCE)
...
#define MEMTOMEM6_DMA_REQUEST            DMA_REQUEST_MEM2MEM
...
#define MEMTOMEM7_DMA_REQUEST            DMA_REQUEST_MEM2MEM
