...
def GetCPPPATH(BSP_ROOT, RTT_ROOT):
	CPPPATH=[
		...
		BSP_ROOT + "/applications/coupler_controller",
		BSP_ROOT + "/board",
		...
		BSP_ROOT + "/packages/lwgps",
		BSP_ROOT + "/packages/lwgps/lwgps/lwgps/src/include",
		BSP_ROOT + "/packages/lwgps/lwgps/lwgps/src/include/lwgps",
