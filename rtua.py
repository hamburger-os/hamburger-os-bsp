...
def GetCPPPATH(BSP_ROOT, RTT_ROOT):
	CPPPATH=[
		...
		BSP_ROOT + "/board",
		BSP_ROOT + "/board/CubeMX_Config/M4_CoreBoard_NOSRAM/Inc",
		...
		BSP_ROOT + "/packages/CMSIS_5/CMSIS/DSP/Include",
		BSP_ROOT + "/packages/CMSIS_5/CMSIS/DSP/Include/dsp",
		BSP_ROOT + "/packages/CMSIS_5/CMSIS/DSP/PrivateInclude",
		...
		BSP_ROOT + "/packages/amrplayer",
		BSP_ROOT + "/packages/crclib/inc",
		BSP_ROOT + "/packages/fffeFrame",
		BSP_ROOT + "/packages/helix/pub",
		BSP_ROOT + "/packages/helix/real",
		BSP_ROOT + "/packages/littlefs",
		BSP_ROOT + "/packages/mem_sandbox",
		BSP_ROOT + "/packages/micropython",
		BSP_ROOT + "/packages/micropython/port",
		BSP_ROOT + "/packages/micropython/port/modules",
		BSP_ROOT + "/packages/micropython/port/modules/machine",
		BSP_ROOT + "/packages/micropython_port",
		BSP_ROOT + "/packages/mp3player",
		BSP_ROOT + "/packages/mp3player/inc",
