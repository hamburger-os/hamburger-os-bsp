...
def GetCPPPATH(BSP_ROOT, RTT_ROOT):
	CPPPATH=[
		...
		BSP_ROOT + "/applications/sto_record_board",
		BSP_ROOT + "/applications/sto_record_board/inc",
		BSP_ROOT + "/board",
		BSP_ROOT + "/board/CubeMX_Config/H7_STO_RecordBoard/Inc",
		BSP_ROOT + "/board/ports",
		BSP_ROOT + "/board/ports/ksz8851",
		BSP_ROOT + "/board/ports/mcp2517",
		...
		BSP_ROOT + "/packages/swops",
		BSP_ROOT + "/packages/swops/inc",
