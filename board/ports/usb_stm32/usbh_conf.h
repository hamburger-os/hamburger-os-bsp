...
#define USB_MEM_ALIGNX              __attribute__((aligned(RT_ALIGN_SIZE)))
...
#define HOST_FS 		1
  ...
  #define USBH_PROCESS_STACK_SIZE    ((uint16_t)USBH_THREAD_STACK_SIZE)
#endif /* (USBH_USE_OS == 1) */
...
#define USBH_memset         rt_memset

/** Alias for memory copy. */
#define USBH_memcpy         rt_memcpy

/* DEBUG macros */

#if (USBH_DEBUG_LEVEL > 0U)
#define  USBH_UsrLog(...)   LOG_I(__VA_ARGS__)
#else
...
#define  USBH_ErrLog(...)   LOG_E(__VA_ARGS__)
#else
#define USBH_ErrLog(...) do {} while (0)
#endif

#if (USBH_DEBUG_LEVEL > 2U)
#define  USBH_DbgLog(...)   LOG_D(__VA_ARGS__)
#else
