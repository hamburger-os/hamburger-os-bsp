...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOG, UART6_RTS_Pin|EMMC_CTRL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, UART3_RTS_Pin|UART4_RTS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI1_CS0_GPIO_Port, SPI1_CS0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : UART6_RTS_Pin EMMC_CTRL_Pin */
  GPIO_InitStruct.Pin = UART6_RTS_Pin|EMMC_CTRL_Pin;
  ...
  /*Configure GPIO pins : UART3_RTS_Pin UART4_RTS_Pin */
  GPIO_InitStruct.Pin = UART3_RTS_Pin|UART4_RTS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
