...
/* Private defines -----------------------------------------------------------*/
#define UART6_RTS_Pin GPIO_PIN_11
...
#define UART7_RTS_GPIO_Port GPIOF
#define SPI1_CS3_Pin GPIO_PIN_1
#define SPI1_CS3_GPIO_Port GPIOC
#define UART3_RTS_Pin GPIO_PIN_8
#define UART3_RTS_GPIO_Port GPIOH
#define UART4_RTS_Pin GPIO_PIN_9
#define UART4_RTS_GPIO_Port GPIOH
