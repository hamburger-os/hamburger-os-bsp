...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, T_CLK_Pin|T_PEN_Pin|T_MISO_Pin|LCD_BL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED0_Pin LED1_Pin T_MOSI_Pin */
  ...
  /*Configure GPIO pins : T_CLK_Pin T_PEN_Pin T_MISO_Pin LCD_BL_Pin */
  GPIO_InitStruct.Pin = T_CLK_Pin|T_PEN_Pin|T_MISO_Pin|LCD_BL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
