...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOG, ETH_RST_Pin|FLASH_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, TEMP_Pin|LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ETH_RST_Pin FLASH_RST_Pin */
  GPIO_InitStruct.Pin = ETH_RST_Pin|FLASH_RST_Pin;
