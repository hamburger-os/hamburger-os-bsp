...
static E_IO_ID get_ctl_id( E_GPIO_ID id )
{
	...
	switch( id )
	{
	case LED1_ID: io_id = E_IO_ID_1; break;
	case LED2_ID: io_id = E_IO_ID_2; break;
	case LED3_ID: io_id = E_IO_ID_3; break;
	case LED4_ID: io_id = E_IO_ID_4; break;
	default:break;
	}
...
extern E_GPIO_RET support_gpio_set( E_GPIO_ID id, E_GPIO_STATE state )
{
    ...
    switch( state )
    {
    case IO_LOW:   if_gpio_reset( ctl_id ); break;
    case IO_HIGH:  if_gpio_set( ctl_id );   break;
    case IO_TOGGLE:if_gpio_toggle( ctl_id );break;
    default:break;
    }
...
extern E_BOARD_ID support_gpio_getBoardId( void )
{
    ...
    switch( slot_id )
    {
    case E_SLOT_ID_1: boardId = ID_TX1_Load; break;
    case E_SLOT_ID_2: boardId = ID_TX1_Child;break;
    case E_SLOT_ID_3: boardId = ID_TX2_Load; break;
    case E_SLOT_ID_4: boardId = ID_TX2_Child;break;
	case E_SLOT_ID_5: boardId = ID_RD; break;
	case E_SLOT_ID_6: boardId = ID_WX; break;
    default:break;
    }
