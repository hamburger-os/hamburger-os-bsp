...
/* 记录插件通道号 */
#define DATA_CHANNEL_TX2ZK ( 0x91U )     /* 记录插件通道 */
...
extern uint8_t InETH0_2_MainCtl_en;
extern uint8_t InETH1_2_MainCtl_en;

extern uint8_t InETH0_diff_flag;
extern uint8_t InETH1_diff_flag;

extern uint32_t InETH0_SendDelay_timer;
extern uint32_t InETH1_SendDelay_timer;

extern uint32_t g_u32_exp_tx_CmpTime;
