...
/* 版本号 */
uint8_t Version[4] = { FIRMWARE_VERSION_A, FIRMWARE_VERSION_B, FIRMWARE_VERSION_C, FIRMWARE_VERSION_D };
/* 版本日期 */
uint16_t Verdate = ( FIRMWARE_YEAR << 9u) + ( FIRMWARE_MONTH << 5u) + FIRMWARE_DAY;

/* 判断CAN超时时间 */
/* 自检变量 */
uint32_t SK2ZJ_time = 0;
uint32_t SK1ZJ_time = 0;
uint32_t JCJKZJ_time = 0;
uint32_t ZK1ZJ_time = 0;
uint32_t ZK2ZJ_time = 0;
